...
char *start_of_field(char *s, int n);
char *end_of_field(char *s, int n);
...
int fieldcmp(char *s1, char *s2) {
    char *start1 = start_of_field(s1, field1);
    char *end1   = end_of_field(s1, field2 ? field2 : field1);
    char *start2 = start_of_field(s2, field1);
    char *end2   = end_of_field(s2, field2 ? field2 : field1);

    int len1 = end1 - start1;
    int len2 = end2 - start2;
    int minlen = len1 < len2 ? len1 : len2;
    int result = strncmp(start1, start2, minlen);
    if (result == 0) {
        result = len1 - len2;  
    }
    return result;
